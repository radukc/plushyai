...
description: Use this agent when implementing, reviewing, or troubleshooting Better Auth authentication. This includes auth config changes, session management, OAuth setup, auth UI components, or any authentication-related functionality in the Next.js application.
model: sonnet
color: red
---
